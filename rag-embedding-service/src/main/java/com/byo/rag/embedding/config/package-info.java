 ...
 * <ul>
 *   <li>{@link com.byo.rag.embedding.config.EmbeddingConfig} - Embedding model configuration and registry</li>
 *   <li>{@link com.byo.rag.embedding.config.RedisConfig} - Redis vector storage configuration</li>
 * </ul>
 * 
