 ...
 * @see com.byo.rag.admin.service.TenantService
 */
@Repository
public interface TenantRepository extends JpaRepository<Tenant, UUID> {
     ...
     * 
     * @param status the {@link com.byo.rag.shared.entity.Tenant.TenantStatus} to filter by
     * @return a {@link List} of tenants matching the specified status
     * @see com.byo.rag.shared.entity.Tenant.TenantStatus
     */
     ...
     * 
     * @param status the {@link com.byo.rag.shared.entity.Tenant.TenantStatus} to count
