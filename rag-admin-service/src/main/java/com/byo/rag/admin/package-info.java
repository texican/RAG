 ...
 * @see com.byo.rag.shared Shared components and entities
 * @see com.byo.rag.admin.service Administrative service implementations
 * @see com.byo.rag.admin.controller Administrative REST controllers
 */
