...
public class TenantController {
     ...
     * @throws com.enterprise.rag.shared.exception.RagException if tenant name/slug already exists
     ...
     * @throws com.enterprise.rag.shared.exception.RagException if tenant creation fails
     */
    @PostMapping
     ...
     * @throws com.enterprise.rag.shared.exception.TenantNotFoundException if tenant with slug not found
     */
     ...
     * @throws org.springframework.security.access.AccessDeniedException if user lacks ADMIN role
     * @throws com.enterprise.rag.shared.exception.TenantNotFoundException if tenant does not exist
     * @throws com.enterprise.rag.shared.exception.RagException if tenant has active dependencies
     */
