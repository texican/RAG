...
public class AuthController {
     ...
     * @throws com.byo.rag.shared.exception.UserNotFoundException if user does not exist
     */
    @PostMapping("/login")
     ...
     * @throws com.byo.rag.shared.exception.RagException if refresh token is invalid or expired
     */
    @PostMapping("/refresh")
     ...
     * @throws com.byo.rag.shared.exception.RagException if email already exists
     ...
     * @throws com.byo.rag.shared.exception.RagException if token is invalid or expired
     * @throws com.byo.rag.shared.exception.UserNotFoundException if associated user not found
     */
