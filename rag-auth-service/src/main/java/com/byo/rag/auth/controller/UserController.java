...
public class UserController {
     ...
     * @throws com.byo.rag.shared.exception.UserNotFoundException if user not found in tenant
     */
    @GetMapping("/{userId}")
     ...
     * @throws org.springframework.security.access.AccessDeniedException if user lacks ADMIN role
     * @throws com.byo.rag.shared.exception.UserNotFoundException if user not found in tenant
     * @throws com.byo.rag.shared.exception.RagException if user has active dependencies
     */
