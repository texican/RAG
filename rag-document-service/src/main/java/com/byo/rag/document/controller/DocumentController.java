...
public class DocumentController {
     ...
     * @throws com.byo.rag.shared.exception.DocumentProcessingException if processing fails
     */
     ...
     * @throws com.byo.rag.shared.exception.DocumentNotFoundException if document doesn't exist
