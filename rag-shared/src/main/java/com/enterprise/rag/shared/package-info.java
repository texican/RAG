 ...
 * @version 1.0
 * @since 1.0
 * @see com.enterprise.rag.shared.entity Base entity classes
 * @see com.enterprise.rag.shared.dto Data transfer objects
 * @see com.enterprise.rag.shared.repository Repository interfaces
 * @see com.enterprise.rag.shared.util Utility classes
 * @see com.enterprise.rag.shared.config Configuration classes
 * @see com.enterprise.rag.shared.exception Exception hierarchy
 */
