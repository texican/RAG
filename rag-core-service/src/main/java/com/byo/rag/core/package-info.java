 ...
 * @see com.byo.rag.core.service RAG service implementations
 * @see com.byo.rag.core.controller RAG API controllers
 * @see com.byo.rag.core.client External service clients
 */
